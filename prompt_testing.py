...
INLINE_CITATION_INSTRUCTION = textwrap.dedent("""\
    *   **Inline Citation Requirement:**
        ...
        *   The inline citation should be placed immediately after the supported statement and before punctuation when possible.
        *   This ensures that each fact is directly verifiable against the corresponding "Supervity Source X" listed later.
    """)
